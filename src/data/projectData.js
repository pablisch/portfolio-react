export const projectData = [
  {
    ...
    description: 'An audio/visual generative music app based on real-time arrivals of trains on the London Underground network using data from the TFL Unified API.',
  ...
  },
  {
    ...
    description: 'A MERN stack image sharing app using a responsive Masonry layout and Cloudinary. An exploration of image layout and React.js.',
  ...
  },
  {
    ...
    description: 'A Facebook clone group engineering project. This was an immersive introduction to all of the MERN stack technologies.',
    note: "As this is hosted on a free tier of <span class='bold'>Render</span>, the backend may take up to 60 seconds to spin up. The app will not work until the backend is running. Please be patient",
    heading: 'FarceBook',
  ...
  },
  {
    ...
    description: 'A practical educational app for learning knots and hitches for Forest School. This is an early exploration of vanilla JavaScript.',
  ...
  },
  {
    ...
    description: 'A playful, early exploration of displaying images using vanilla JavaScript and Flexbox to create a new way of viewing photo collections.',
  ...
  },
  {
    ...
    description: 'A companion to the board game, Eclipse, A new Dawn for the Galaxy, which automates the complex game setup.',
  ...
  },
  {
    ...
    repo: 'https://github.com/pablisch/eclipse-layout-react',
    description: 'A playful app that generates alternative station names for the London Underground based on user themes using the GPT-3 API.',
    note: "Select or deselect names from the player form and click the <span class='bold'>GENERATE</span> button to generate the starting game layout.",
    url: 'https://eclipse-generator.onrender.com/',
    heading: 'Eclipse Layout Generator',
    subheading:
