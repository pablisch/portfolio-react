export const projectData = [
  {
    ...
    description: 'A generative music app based on real-time arrivals of trains on the London Underground network using data from the TFL Unified API.',
  ...
  },
  {
    ...
    description: 'A MERN stack image app',
  ...
  },
  {
    ...
    description: 'A Facebook clone using the MERN stack',
    note: "As this is hosted on a free tier of <span class='bold'>Render</span>, the backend may take up to 60 seconds to spin up. The app will not work until the backend is running. Please be patient",
    heading: 'FarceBook',
  ...
  },
  {
    ...
    description: 'An educational app for learning knots and hitches',
  ...
  },
  {
    ...
    description: 'A playful exploration of how to display your holiday photos',
  ...
  },
  {
    ...
    description: 'A companion to the board game, Eclipse, A new Dawn for the Galaxy',
  ...
  },
  {
    ...
    repo: 'https://github.com/pablisch/eclipse-layout-react',
    description: 'Use OpenAI\'s GPT-3 to generate alternative station names for the London Underground',
    note: "Select or deselect names from the player form and click the <span class='bold'>GENERATE</span> button to generate the starting game layout.",
    url: 'https://eclipse-generator.onrender.com/',
    heading: 'Eclipse Layout Generator',
    subheading:
